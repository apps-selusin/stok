...
<?php if ($t14_piutang->NoPiutang->Visible) { // NoPiutang ?>
	...
	<?php } else { ?>
		<th data-name="NoPiutang" class="<?php echo $t14_piutang->NoPiutang->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t14_piutang->SortUrl($t14_piutang->NoPiutang) ?>',2);"><div id="elh_t14_piutang_NoPiutang" class="t14_piutang_NoPiutang">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $t14_piutang->NoPiutang->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($t14_piutang->NoPiutang->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($t14_piutang->NoPiutang->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
