...
class ct14_piutang_list extends ct14_piutang {
	...
	function __construct() {
		...
		$this->AddUrl = "t14_piutangadd.php";
...
?>
<?php if ($t14_piutang->id->Visible) { // id ?>
	<?php if ($t14_piutang->SortUrl($t14_piutang->id) == "") { ?>
		<th data-name="id" class="<?php echo $t14_piutang->id->HeaderCellClass() ?>"><div id="elh_t14_piutang_id" class="t14_piutang_id"><div class="ewTableHeaderCaption"><?php echo $t14_piutang->id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id" class="<?php echo $t14_piutang->id->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t14_piutang->SortUrl($t14_piutang->id) ?>',2);"><div id="elh_t14_piutang_id" class="t14_piutang_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $t14_piutang->id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($t14_piutang->id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($t14_piutang->id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
?>
	<?php if ($t14_piutang->id->Visible) { // id ?>
		<td data-name="id"<?php echo $t14_piutang->id->CellAttributes() ?>>
<span id="el<?php echo $t14_piutang_list->RowCnt ?>_t14_piutang_id" class="t14_piutang_id">
<span<?php echo $t14_piutang->id->ViewAttributes() ?>>
<?php echo $t14_piutang->id->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($t14_piutang->NoPiutang->Visible) { // NoPiutang ?>
