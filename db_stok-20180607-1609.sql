...
(2048, 1, 't08_beliview.php?showdetail=&id=1', 1, '1501001', 1, '2018-06-06', '21:25:00', 'Beli', 'PO201806060001', 5.00, 100000.00, 0.00, 0.00, 5.00, 500000.00),
(2049, 2, 't08_beliview.php?showdetail=&id=2', 68, '1501068', 1, '2018-06-07', '01:11:00', 'Beli', 'PO201806070002', 2.00, 50000.00, 0.00, 0.00, 2.00, 100000.00);
...
(8, 3, 'laporan mutasi, inputan filtering awal disamakan dengan laporan stok', NULL, 2, '2018-06-07 07:22:23');
...
--
-- Stand-in structure for view `v05_article`
-- (See below for the actual view)
--
CREATE TABLE `v05_article` (
`id` int(11)
,`SubGroupID` int(11)
,`Kode` varchar(7)
,`Nama` varchar(75)
...
--
DROP TABLE IF EXISTS `v05_article`;
