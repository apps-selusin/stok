...
<div class="nav-tabs-custom" id="t96_employees_edit"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $t96_employees_edit->MultiPages->NavStyle() ?>">
		<li<?php echo $t96_employees_edit->MultiPages->TabStyle("1") ?>><a href="#tab_t96_employees1" data-toggle="tab"><?php echo $t96_employees->PageCaption(1) ?></a></li>
		<li<?php echo $t96_employees_edit->MultiPages->TabStyle("2") ?>><a href="#tab_t96_employees2" data-toggle="tab"><?php echo $t96_employees->PageCaption(2) ?></a></li>
		<li<?php echo $t96_employees_edit->MultiPages->TabStyle("3") ?>><a href="#tab_t96_employees3" data-toggle="tab"><?php echo $t96_employees->PageCaption(3) ?></a></li>
		<li<?php echo $t96_employees_edit->MultiPages->TabStyle("4") ?>><a href="#tab_t96_employees4" data-toggle="tab"><?php echo $t96_employees->PageCaption(4) ?></a></li>
	</ul>
	<div class="tab-content"><!-- multi-page .nav-tabs-custom .tab-content -->
		<div class="tab-pane<?php echo $t96_employees_edit->MultiPages->PageStyle("1") ?>" id="tab_t96_employees1"><!-- multi-page .tab-pane -->
...
<input type="text" data-table="t96_employees" data-field="x_LastName" data-page="1" name="x_LastName" id="x_LastName" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($t96_employees->LastName->getPlaceHolder()) ?>" value="<?php echo $t96_employees->LastName->EditValue ?>"<?php echo $t96_employees->LastName->EditAttributes() ?>>
</span>
...
<input type="text" data-table="t96_employees" data-field="x_FirstName" data-page="1" name="x_FirstName" id="x_FirstName" size="30" maxlength="10" placeholder="<?php echo ew_HtmlEncode($t96_employees->FirstName->getPlaceHolder()) ?>" value="<?php echo $t96_employees->FirstName->EditValue ?>"<?php echo $t96_employees->FirstName->EditAttributes() ?>>
</span>
...
<input type="text" data-table="t96_employees" data-field="x_Title" data-page="1" name="x_Title" id="x_Title" size="30" maxlength="30" placeholder="<?php echo ew_HtmlEncode($t96_employees->Title->getPlaceHolder()) ?>" value="<?php echo $t96_employees->Title->EditValue ?>"<?php echo $t96_employees->Title->EditAttributes() ?>>
</span>
...
<input type="text" data-table="t96_employees" data-field="x_TitleOfCourtesy" data-page="1" name="x_TitleOfCourtesy" id="x_TitleOfCourtesy" size="30" maxlength="25" placeholder="<?php echo ew_HtmlEncode($t96_employees->TitleOfCourtesy->getPlaceHolder()) ?>" value="<?php echo $t96_employees->TitleOfCourtesy->EditValue ?>"<?php echo $t96_employees->TitleOfCourtesy->EditAttributes() ?>>
</span>
...
<input type="text" data-table="t96_employees" data-field="x_BirthDate" data-page="1" name="x_BirthDate" id="x_BirthDate" placeholder="<?php echo ew_HtmlEncode($t96_employees->BirthDate->getPlaceHolder()) ?>" value="<?php echo $t96_employees->BirthDate->EditValue ?>"<?php echo $t96_employees->BirthDate->EditAttributes() ?>>
</span>
...
<input type="text" data-table="t96_employees" data-field="x_HireDate" data-page="1" name="x_HireDate" id="x_HireDate" placeholder="<?php echo ew_HtmlEncode($t96_employees->HireDate->getPlaceHolder()) ?>" value="<?php echo $t96_employees->HireDate->EditValue ?>"<?php echo $t96_employees->HireDate->EditAttributes() ?>>
</span>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $t96_employees_edit->MultiPages->PageStyle("2") ?>" id="tab_t96_employees2"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $t96_employees_edit->MultiPages->PageStyle("3") ?>" id="tab_t96_employees3"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
...
<input type="text" data-table="t96_employees" data-field="x_HomePhone" data-page="3" name="x_HomePhone" id="x_HomePhone" size="30" maxlength="24" placeholder="<?php echo ew_HtmlEncode($t96_employees->HomePhone->getPlaceHolder()) ?>" value="<?php echo $t96_employees->HomePhone->EditValue ?>"<?php echo $t96_employees->HomePhone->EditAttributes() ?>>
</span>
...
<input type="text" data-table="t96_employees" data-field="x__Email" data-page="3" name="x__Email" id="x__Email" size="30" maxlength="30" placeholder="<?php echo ew_HtmlEncode($t96_employees->_Email->getPlaceHolder()) ?>" value="<?php echo $t96_employees->_Email->EditValue ?>"<?php echo $t96_employees->_Email->EditAttributes() ?>>
</span>
...
<input type="text" data-table="t96_employees" data-field="x_Photo" data-page="3" name="x_Photo" id="x_Photo" size="30" maxlength="255" placeholder="<?php echo ew_HtmlEncode($t96_employees->Photo->getPlaceHolder()) ?>" value="<?php echo $t96_employees->Photo->EditValue ?>"<?php echo $t96_employees->Photo->EditAttributes() ?>>
</span>
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $t96_employees_edit->MultiPages->PageStyle("4") ?>" id="tab_t96_employees4"><!-- multi-page .tab-pane -->
<div class="ewEditDiv"><!-- page* -->
...
<textarea data-table="t96_employees" data-field="x_Notes" data-page="4" name="x_Notes" id="x_Notes" cols="35" rows="4" placeholder="<?php echo ew_HtmlEncode($t96_employees->Notes->getPlaceHolder()) ?>"<?php echo $t96_employees->Notes->EditAttributes() ?>><?php echo $t96_employees->Notes->EditValue ?></textarea>
</span>
...
<input type="text" data-table="t96_employees" data-field="x_ReportsTo" data-page="4" name="x_ReportsTo" id="x_ReportsTo" size="30" placeholder="<?php echo ew_HtmlEncode($t96_employees->ReportsTo->getPlaceHolder()) ?>" value="<?php echo $t96_employees->ReportsTo->EditValue ?>"<?php echo $t96_employees->ReportsTo->EditAttributes() ?>>
</span>
...
<input type="text" data-table="t96_employees" data-field="x_Password" data-page="4" name="x_Password" id="x_Password" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($t96_employees->Password->getPlaceHolder()) ?>" value="<?php echo $t96_employees->Password->EditValue ?>"<?php echo $t96_employees->Password->EditAttributes() ?>>
</span>
...
<?php } else { ?>
<span id="el_t96_employees_UserLevel">
<select data-table="t96_employees" data-field="x_UserLevel" data-page="4" data-value-separator="<?php echo $t96_employees->UserLevel->DisplayValueSeparatorAttribute() ?>" id="x_UserLevel" name="x_UserLevel"<?php echo $t96_employees->UserLevel->EditAttributes() ?>>
...
<input type="text" data-table="t96_employees" data-field="x_Username" data-page="4" name="x_Username" id="x_Username" size="30" maxlength="20" placeholder="<?php echo ew_HtmlEncode($t96_employees->Username->getPlaceHolder()) ?>" value="<?php echo $t96_employees->Username->EditValue ?>"<?php echo $t96_employees->Username->EditAttributes() ?>>
</span>
...
?>
<input type="checkbox" data-table="t96_employees" data-field="x_Activated" data-page="4" name="x_Activated[]" id="x_Activated[]" value="1"<?php echo $selwrk ?><?php echo $t96_employees->Activated->EditAttributes() ?>>
</span>
...
<textarea data-table="t96_employees" data-field="x_Profile" data-page="4" name="x_Profile" id="x_Profile" cols="35" rows="4" placeholder="<?php echo ew_HtmlEncode($t96_employees->Profile->getPlaceHolder()) ?>"<?php echo $t96_employees->Profile->EditAttributes() ?>><?php echo $t96_employees->Profile->EditValue ?></textarea>
</span>
