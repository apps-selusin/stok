...
$t10_hutangdetail = NULL;

//
// Table class for t10_hutangdetail
//
class ct10_hutangdetail extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't10_hutangdetail';
		$this->TableName = 't10_hutangdetail';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t10_hutangdetail`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t10_hutangdetail', 't10_hutangdetail', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// HutangID
		$this->HutangID = new cField('t10_hutangdetail', 't10_hutangdetail', 'x_HutangID', 'HutangID', '`HutangID`', '`HutangID`', 3, -1, FALSE, '`HutangID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->HutangID->Sortable = TRUE; // Allow sort
		$this->HutangID->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['HutangID'] = &$this->HutangID;

		// NoBayar
		$this->NoBayar = new cField('t10_hutangdetail', 't10_hutangdetail', 'x_NoBayar', 'NoBayar', '`NoBayar`', '`NoBayar`', 200, -1, FALSE, '`NoBayar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NoBayar->Sortable = TRUE; // Allow sort
		$this->fields['NoBayar'] = &$this->NoBayar;

		// Tgl
		$this->Tgl = new cField('t10_hutangdetail', 't10_hutangdetail', 'x_Tgl', 'Tgl', '`Tgl`', ew_CastDateFieldForLike('`Tgl`', 7, "DB"), 133, 7, FALSE, '`Tgl`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// JumlahBayar
		$this->JumlahBayar = new cField('t10_hutangdetail', 't10_hutangdetail', 'x_JumlahBayar', 'JumlahBayar', '`JumlahBayar`', '`JumlahBayar`', 4, -1, FALSE, '`JumlahBayar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "t09_hutang") {
			if ($this->HutangID->getSessionValue() <> "")
				$sMasterFilter .= "`id`=" . ew_QuotedValue($this->HutangID->getSessionValue(), EW_DATATYPE_NUMBER, "DB");
			else
				return "";
		}
	...
	function GetDetailFilter() {
		...
		if ($this->getCurrentMasterTable() == "t09_hutang") {
			if ($this->HutangID->getSessionValue() <> "")
				$sDetailFilter .= "`HutangID`=" . ew_QuotedValue($this->HutangID->getSessionValue(), EW_DATATYPE_NUMBER, "DB");
			else
				return "";
		}
	...
	// Master filter
	function SqlMasterFilter_t09_hutang() {
		return "`id`=@id@";
	}

	// Detail filter
	function SqlDetailFilter_t09_hutang() {
		return "`HutangID`=@HutangID@";
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t10_hutangdetail`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t10_hutangdetaillist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "t10_hutangdetailedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "t10_hutangdetailadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t10_hutangdetailview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t10_hutangdetailview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t10_hutangdetailadd.php?" . $this->UrlParm($parm);
		else
			$url = "t10_hutangdetailadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t10_hutangdetailedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t10_hutangdetailadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t10_hutangdetaildelete.php", $this->UrlParm());
	}

	// Add master url
	function AddMasterUrl($url) {
		if ($this->getCurrentMasterTable() == "t09_hutang" && strpos($url, EW_TABLE_SHOW_MASTER . "=") === FALSE) {
			$url .= (strpos($url, "?") !== FALSE ? "&" : "?") . EW_TABLE_SHOW_MASTER . "=" . $this->getCurrentMasterTable();
			$url .= "&fk_id=" . urlencode($this->HutangID->CurrentValue);
		}
		return $url;
	}
	...
	function LoadListRowValues(&$rs) {
		...
		$this->HutangID->setDbValue($rs->fields('HutangID'));
	...
	function RenderEditRow() {
		...
		$this->HutangID->EditValue = $this->HutangID->CurrentValue;
