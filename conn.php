...
if ($_SERVER["REMOTE_ADDR"] == "127.0.0.1"  || $_SERVER["REMOTE_ADDR"] == "::1"  || $_SERVER["HTTP_POST"] == "localhost" ) {
	...
	$database_conn = "db_stok"; //$database_conn = "zecorind_mitra2";
	$username_conn = "root"; //$username_conn = "zecorind_root";
	$password_conn = "admin";
}
else {
	$hostname_conn = "mysql.idhostinger.com";
	$database_conn = "u945388674_tetra"; //$database_conn = "zecorind_mitra2";
	$username_conn = "u945388674_tetra"; //$username_conn = "zecorind_root";
