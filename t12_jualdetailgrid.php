...
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next(":not([disabled])").click();" tabindex="-1" class="form-control ewLookupText" id="lu_x<?php echo $t12_jualdetail_grid->RowIndex ?>_ArticleID"><?php echo (strval($t12_jualdetail->ArticleID->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $t12_jualdetail->ArticleID->ViewValue); ?></span>
</span>
