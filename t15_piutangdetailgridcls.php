...
$t15_piutangdetail_grid = NULL; // Initialize page object first

class ct15_piutangdetail_grid extends ct15_piutangdetail {
	...
	// Page object name
	var $PageObjName = 't15_piutangdetail_grid';

	// Grid form hidden field names
	var $FormName = 'ft15_piutangdetailgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t15_piutangdetail"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function RenderRow() {
		...
		$this->JumlahBayar->ViewCustomAttributes = "";
			...
			$this->JumlahBayar->EditValue = ew_FormatNumber($this->JumlahBayar->EditValue, -2, -1, -2, 0);
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "t14_piutang") {
			$this->PiutangID->Visible = FALSE;
			if ($GLOBALS["t14_piutang"]->EventCancelled) $this->EventCancelled = TRUE;
		}
