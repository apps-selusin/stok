...
$t10_hutangdetail_grid = NULL; // Initialize page object first

class ct10_hutangdetail_grid extends ct10_hutangdetail {
	...
	// Page object name
	var $PageObjName = 't10_hutangdetail_grid';

	// Grid form hidden field names
	var $FormName = 'ft10_hutangdetailgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t10_hutangdetail"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadFormValues() {
		...
		$this->NoBayar->setOldValue($objForm->GetValue("o_NoBayar"));
	...
	function SetupMasterParms() {
		...
		if ($sMasterTblVar == "t09_hutang") {
			$this->HutangID->Visible = FALSE;
			if ($GLOBALS["t09_hutang"]->EventCancelled) $this->EventCancelled = TRUE;
		}
