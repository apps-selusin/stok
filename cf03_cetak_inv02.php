...
// sum total
$q = "select sum(subtotal) as total from v04_jual where noso = '".$_POST["t11_jual_noso"]."'"; //echo $q; //exit;
$r = Conn()->Execute($q);
$total = 0;
if (!$r->EOF) {
...
// collect data
$q = "select * from v04_jual where noso = '".$_POST["t11_jual_noso"]."'"; //echo $msql; exit;
$r = Conn()->Execute($q); 

//$total = $r->fields["total"];
$no_po = $r->fields["CustomerPO"];
$tgl_po_raw = strtotime($r->fields["TglSO"]);
...
$html .= '<table border="0" width="100%">';
$html .= '<tr><td width="100">No.</td><td>: '.$r->fields["NoSO"].'</td></tr>';
$inv_tgl = strtotime($r->fields["TglSO"]);
$html .= '<tr><td>Tanggal</td><td>: '.date("d", $inv_tgl).' '.$anamabln_[intval(date("m", $inv_tgl))].' '.date("Y", $inv_tgl).'</td></tr>';
$html .= '<tr><td>&nbsp;</td><td>&nbsp;</td></tr>';
$html .= '<tr><td>Customer</td><td>: '.$r->fields["CustomerNama"].'</td></tr>';
$html .= '<tr><td>&nbsp;</td><td>&nbsp;</td></tr>';
$html .= '</table>';
...
while(!$r->EOF) {
	...
	<tr>
		...
		<td width="270"> '.$r->fields["ArticleNama"].'</td>
		<td width="50" align="right">'.$r->fields["Qty"].' &nbsp;</td>
		<td width="50"> '.$r->fields["SatuanNama"].'</td>
		<td width="85"><table border="0" width="100%"><tr><td width="25"> Rp.</td><td width="55" align="right">'.number_format($r->fields["HargaJual"]).' &nbsp;</td></tr></table></td>
		<td width="90"><table border="0" width="100%"><tr><td width="25"> Rp.</td><td width="65" align="right">'.number_format($r->fields["SubTotal"]).' &nbsp;</td></tr></table></td>
	</tr>
	';
	$r->MoveNext();
}
...
$html .= '<tr><td>&nbsp;</td></tr>';
$html .= '<tr><td>&nbsp;</td></tr>';
$html .= '<tr><td>Keterangan :</td></tr>';
$html .= '<tr><td>-&nbsp;Non PPN dan Non NPWP</td></tr>';
$html .= '<tr><td>-&nbsp;Rekening transfer :</td></tr>';
$html .= '<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bank [bank] - no. rekening [no_rek] - atas nama [nama]</td></tr>';
$html .= '<tr><td>-&nbsp;Invoice ini berdasar pada PO No. '.$no_po.' Tgl. '.$tgl_po.'</td></tr>';
$html .= '</table>';
...
$html .= '<tr><td>&nbsp;</td></tr>';
$html .= '<tr><td>&nbsp;</td></tr>';
$html .= '<tr><td align="left">Administrator</td></tr>';
$html .= '</table>';
