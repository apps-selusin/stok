...
<div class="nav-tabs-custom" id="t96_employees_add"><!-- multi-page .nav-tabs-custom -->
	<ul class="nav<?php echo $t96_employees_add->MultiPages->NavStyle() ?>">
		<li<?php echo $t96_employees_add->MultiPages->TabStyle("1") ?>><a href="#tab_t96_employees1" data-toggle="tab"><?php echo $t96_employees->PageCaption(1) ?></a></li>
		<li<?php echo $t96_employees_add->MultiPages->TabStyle("2") ?>><a href="#tab_t96_employees2" data-toggle="tab"><?php echo $t96_employees->PageCaption(2) ?></a></li>
		<li<?php echo $t96_employees_add->MultiPages->TabStyle("3") ?>><a href="#tab_t96_employees3" data-toggle="tab"><?php echo $t96_employees->PageCaption(3) ?></a></li>
		<li<?php echo $t96_employees_add->MultiPages->TabStyle("4") ?>><a href="#tab_t96_employees4" data-toggle="tab"><?php echo $t96_employees->PageCaption(4) ?></a></li>
	</ul>
	<div class="tab-content"><!-- multi-page .nav-tabs-custom .tab-content -->
		<div class="tab-pane<?php echo $t96_employees_add->MultiPages->PageStyle("1") ?>" id="tab_t96_employees1"><!-- multi-page .tab-pane -->
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $t96_employees_add->MultiPages->PageStyle("2") ?>" id="tab_t96_employees2"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $t96_employees_add->MultiPages->PageStyle("3") ?>" id="tab_t96_employees3"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
...
<?php } ?>
		...
		<div class="tab-pane<?php echo $t96_employees_add->MultiPages->PageStyle("4") ?>" id="tab_t96_employees4"><!-- multi-page .tab-pane -->
<div class="ewAddDiv"><!-- page* -->
