...
define("EWR_PROJECT_ID", "{A2EF3792-3541-4459-9D68-D8F1DBA083C2}", TRUE); // Project ID
...
define("EWR_RANDOM_KEY", 'xpdj8zlAJfNor18V', TRUE); // Random key for encryption
...
define("EWR_TABLE_PREFIX", "{A2EF3792-3541-4459-9D68-D8F1DBA083C2}", TRUE);
