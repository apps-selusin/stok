...
<span id="as_x_SatuanID" style="white-space: nowrap; z-index: 8920">
	<input type="text" name="sv_x_SatuanID" id="sv_x_SatuanID" value="<?php echo $t08_po->SatuanID->EditValue ?>" size="30" placeholder="<?php echo ew_HtmlEncode($t08_po->SatuanID->getPlaceHolder()) ?>" data-placeholder="<?php echo ew_HtmlEncode($t08_po->SatuanID->getPlaceHolder()) ?>"<?php echo $t08_po->SatuanID->EditAttributes() ?>>
</span>
...
<?php if ($t08_po->SubTotal->Visible) { // SubTotal ?>
	<div id="r_SubTotal" class="form-group">
		<label id="elh_t08_po_SubTotal" for="x_SubTotal" class="<?php echo $t08_po_edit->LeftColumnClass ?>"><?php echo $t08_po->SubTotal->FldCaption() ?></label>
		<div class="<?php echo $t08_po_edit->RightColumnClass ?>"><div<?php echo $t08_po->SubTotal->CellAttributes() ?>>
<span id="el_t08_po_SubTotal">
<input type="text" data-table="t08_po" data-field="x_SubTotal" name="x_SubTotal" id="x_SubTotal" size="10" placeholder="<?php echo ew_HtmlEncode($t08_po->SubTotal->getPlaceHolder()) ?>" value="<?php echo $t08_po->SubTotal->EditValue ?>"<?php echo $t08_po->SubTotal->EditAttributes() ?>>
</span>
<?php echo $t08_po->SubTotal->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
