...
$t09_hutang_view = NULL; // Initialize page object first

class ct09_hutang_view extends ct09_hutang {
	...
	// Page object name
	var $PageObjName = 't09_hutang_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t09_hutanglist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t09_hutanglist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupOtherOptions() {
		...
		$item = &$option->Add("detail_t10_hutangdetail");
		$body = $Language->Phrase("ViewPageDetailLink") . $Language->TablePhrase("t10_hutangdetail", "TblCaption");
		...
		$links = "";
		if ($GLOBALS["t10_hutangdetail_grid"] && $GLOBALS["t10_hutangdetail_grid"]->DetailView && $Security->CanView() && $Security->AllowView(CurrentProjectID() . 't10_hutangdetail')) {
			$links .= "<li><a class=\"ewRowLink ewDetailView\" data-action=\"view\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("MasterDetailViewLink")) . "\" href=\"" . ew_HtmlEncode($this->GetViewUrl(EW_TABLE_SHOW_DETAIL . "=t10_hutangdetail")) . "\">" . ew_HtmlImageAndText($Language->Phrase("MasterDetailViewLink")) . "</a></li>";
			if ($DetailViewTblVar <> "") $DetailViewTblVar .= ",";
			$DetailViewTblVar .= "t10_hutangdetail";
		}
		if ($GLOBALS["t10_hutangdetail_grid"] && $GLOBALS["t10_hutangdetail_grid"]->DetailEdit && $Security->CanEdit() && $Security->AllowEdit(CurrentProjectID() . 't10_hutangdetail')) {
			$links .= "<li><a class=\"ewRowLink ewDetailEdit\" data-action=\"edit\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("MasterDetailEditLink")) . "\" href=\"" . ew_HtmlEncode($this->GetEditUrl(EW_TABLE_SHOW_DETAIL . "=t10_hutangdetail")) . "\">" . ew_HtmlImageAndText($Language->Phrase("MasterDetailEditLink")) . "</a></li>";
			if ($DetailEditTblVar <> "") $DetailEditTblVar .= ",";
			$DetailEditTblVar .= "t10_hutangdetail";
		}
		if ($GLOBALS["t10_hutangdetail_grid"] && $GLOBALS["t10_hutangdetail_grid"]->DetailAdd && $Security->CanAdd() && $Security->AllowAdd(CurrentProjectID() . 't10_hutangdetail')) {
			$links .= "<li><a class=\"ewRowLink ewDetailCopy\" data-action=\"add\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("MasterDetailCopyLink")) . "\" href=\"" . ew_HtmlEncode($this->GetCopyUrl(EW_TABLE_SHOW_DETAIL . "=t10_hutangdetail")) . "\">" . ew_HtmlImageAndText($Language->Phrase("MasterDetailCopyLink")) . "</a></li>";
		...
		$item->Body = $body;
		$item->Visible = $Security->AllowList(CurrentProjectID() . 't10_hutangdetail');
		if ($item->Visible) {
	...
	function ExportData() {
		...
		// Export detail records (t10_hutangdetail)
		if (EW_EXPORT_DETAIL_RECORDS && in_array("t10_hutangdetail", explode(",", $this->getCurrentDetailTable()))) {
			global $t10_hutangdetail;
			if (!isset($t10_hutangdetail)) $t10_hutangdetail = new ct10_hutangdetail;
			$rsdetail = $t10_hutangdetail->LoadRs($t10_hutangdetail->GetDetailFilter()); // Load detail records
			if ($rsdetail && !$rsdetail->EOF) {
				...
				if ($this->Export <> "csv" || EW_EXPORT_DETAIL_RECORDS_FOR_CSV) {
					...
					$oldtbl = $Doc->Table;
					$Doc->Table = $t10_hutangdetail;
					$t10_hutangdetail->ExportDocument($Doc, $rsdetail, 1, $detailcnt);
					$Doc->Table = $oldtbl;
				}
	...
	function SetupDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("t10_hutangdetail", $DetailTblVar)) {
				...
				if ($GLOBALS["t10_hutangdetail_grid"]->DetailView) {
					$GLOBALS["t10_hutangdetail_grid"]->CurrentMode = "view";
...
// Create page object
if (!isset($t09_hutang_view)) $t09_hutang_view = new ct09_hutang_view();

// Page init
$t09_hutang_view->Page_Init();

// Page main
$t09_hutang_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t09_hutang_view->Page_Render();
?>
...
var CurrentForm = ft09_hutangview = new ew_Form("ft09_hutangview", "view");

// Form_CustomValidate event
ft09_hutangview.Form_CustomValidate = 
...
<?php if ($t09_hutang->Export == "") { ?>
<div class="ewToolbar">
<?php $t09_hutang_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t09_hutang_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $t09_hutang_view->ShowPageHeader(); ?>
<?php
$t09_hutang_view->ShowMessage();
?>
<?php if (!$t09_hutang_view->IsModal) { ?>
<?php if ($t09_hutang->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t09_hutang_view->Pager)) $t09_hutang_view->Pager = new cPrevNextPager($t09_hutang_view->StartRec, $t09_hutang_view->DisplayRecs, $t09_hutang_view->TotalRecs, $t09_hutang_view->AutoHidePager) ?>
<?php if ($t09_hutang_view->Pager->RecordCount > 0 && $t09_hutang_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t09_hutang_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t09_hutang_view->PageUrl() ?>start=<?php echo $t09_hutang_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t09_hutang_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t09_hutang_view->PageUrl() ?>start=<?php echo $t09_hutang_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t09_hutang_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t09_hutang_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t09_hutang_view->PageUrl() ?>start=<?php echo $t09_hutang_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t09_hutang_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t09_hutang_view->PageUrl() ?>start=<?php echo $t09_hutang_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t09_hutang_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="ft09_hutangview" id="ft09_hutangview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t09_hutang_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t09_hutang_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t09_hutang">
<input type="hidden" name="modal" value="<?php echo intval($t09_hutang_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($t09_hutang->NoHutang->Visible) { // NoHutang ?>
	<tr id="r_NoHutang">
		<td class="col-sm-2"><span id="elh_t09_hutang_NoHutang"><?php echo $t09_hutang->NoHutang->FldCaption() ?></span></td>
...
<?php echo $t09_hutang->NoHutang->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t09_hutang->BeliID->Visible) { // BeliID ?>
	<tr id="r_BeliID">
		<td class="col-sm-2"><span id="elh_t09_hutang_BeliID"><?php echo $t09_hutang->BeliID->FldCaption() ?></span></td>
...
<?php echo $t09_hutang->BeliID->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t09_hutang->JumlahHutang->Visible) { // JumlahHutang ?>
	<tr id="r_JumlahHutang">
		<td class="col-sm-2"><span id="elh_t09_hutang_JumlahHutang"><?php echo $t09_hutang->JumlahHutang->FldCaption() ?></span></td>
...
<?php if ($t09_hutang->JumlahBayar->Visible) { // JumlahBayar ?>
	<tr id="r_JumlahBayar">
		<td class="col-sm-2"><span id="elh_t09_hutang_JumlahBayar"><?php echo $t09_hutang->JumlahBayar->FldCaption() ?></span></td>
...
<?php } ?>
<?php
	if (in_array("t10_hutangdetail", explode(",", $t09_hutang->getCurrentDetailTable())) && $t10_hutangdetail->DetailView) {
?>
...
<?php if ($t09_hutang->Export == "") { ?>
<script type="text/javascript">
ft09_hutangview.Init();
</script>
<?php } ?>
<?php
$t09_hutang_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($t09_hutang->Export == "") { ?>
...
<?php
$t09_hutang_view->Page_Terminate();
?>
