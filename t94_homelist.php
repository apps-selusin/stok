...
class ct94_home_list extends ct94_home {
	...
	function ProcessFilterList() {
		...
		if (@$_POST["ajax"] == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->SetSearchFilters(CurrentUserName(), "ft94_homelistsrch", $filters);
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $Language->Phrase("SearchPanel") . "\" data-caption=\"" . $Language->Phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"ft94_homelistsrch\">" . $Language->Phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
...
var CurrentSearchForm = ft94_homelistsrch = new ew_Form("ft94_homelistsrch");
</script>
<script type="text/javascript">
...
<?php } ?>
<?php if ($t94_home_list->SearchOptions->Visible()) { ?>
<?php $t94_home_list->SearchOptions->Render("body") ?>
<?php } ?>
<?php if ($t94_home_list->FilterOptions->Visible()) { ?>
<?php $t94_home_list->FilterOptions->Render("body") ?>
<?php } ?>
...
if ($t94_home->CurrentAction == "gridadd") {
	...
	if ($t94_home_list->AuditTrailOnSearch && $t94_home_list->Command == "search" && !$t94_home_list->RestoreSearch) {
		$searchparm = ew_ServerVar("QUERY_STRING");
		$searchsql = $t94_home_list->getSessionWhere();
		$t94_home_list->WriteAuditTrailOnSearch($searchparm, $searchsql);
	}
}
$t94_home_list->RenderOtherOptions();
?>
<?php if ($Security->CanSearch()) { ?>
<?php if ($t94_home->Export == "" && $t94_home->CurrentAction == "") { ?>
<form name="ft94_homelistsrch" id="ft94_homelistsrch" class="form-inline ewForm ewExtSearchForm" action="<?php echo ew_CurrentPage() ?>">
<?php $SearchPanelClass = ($t94_home_list->SearchWhere <> "") ? " in" : " in"; ?>
<div id="ft94_homelistsrch_SearchPanel" class="ewSearchPanel collapse<?php echo $SearchPanelClass ?>">
<input type="hidden" name="cmd" value="search">
<input type="hidden" name="t" value="t94_home">
	<div class="ewBasicSearch">
<div id="xsr_1" class="ewRow">
	<div class="ewQuickSearch input-group">
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="form-control" value="<?php echo ew_HtmlEncode($t94_home_list->BasicSearch->getKeyword()) ?>" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("Search")) ?>">
	<input type="hidden" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" id="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="<?php echo ew_HtmlEncode($t94_home_list->BasicSearch->getType()) ?>">
	<div class="input-group-btn">
		<button type="button" data-toggle="dropdown" class="btn btn-default"><span id="searchtype"><?php echo $t94_home_list->BasicSearch->getTypeNameShort() ?></span><span class="caret"></span></button>
		<ul class="dropdown-menu pull-right" role="menu">
			<li<?php if ($t94_home_list->BasicSearch->getType() == "") echo " class=\"active\""; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this)"><?php echo $Language->Phrase("QuickSearchAuto") ?></a></li>
			<li<?php if ($t94_home_list->BasicSearch->getType() == "=") echo " class=\"active\""; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this,'=')"><?php echo $Language->Phrase("QuickSearchExact") ?></a></li>
			<li<?php if ($t94_home_list->BasicSearch->getType() == "AND") echo " class=\"active\""; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this,'AND')"><?php echo $Language->Phrase("QuickSearchAll") ?></a></li>
			<li<?php if ($t94_home_list->BasicSearch->getType() == "OR") echo " class=\"active\""; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this,'OR')"><?php echo $Language->Phrase("QuickSearchAny") ?></a></li>
		</ul>
...
<?php if ($t94_home->kode->Visible) { // kode ?>
	...
	<?php } else { ?>
		<th data-name="kode" class="<?php echo $t94_home->kode->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t94_home->SortUrl($t94_home->kode) ?>',2);"><div id="elh_t94_home_kode" class="t94_home_kode">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $t94_home->kode->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($t94_home->kode->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($t94_home->kode->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($t94_home->Export == "") { ?>
<script type="text/javascript">
ft94_homelistsrch.FilterList = <?php echo $t94_home_list->GetFilterList() ?>;
ft94_homelistsrch.Init();
ft94_homelist.Init();
</script>
<?php } ?>
<?php
