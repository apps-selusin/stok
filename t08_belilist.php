...
ft08_belilist.Lists["x_ArticleID"] = {"LinkField":"x_id","Ajax":true,"AutoFill":true,"DisplayFields":["x_Kode","x_Nama","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t06_article"};
...
<span class="ewLookupList">
	<span onclick="jQuery(this).parent().next().click();" tabindex="-1" class="form-control ewLookupText" id="lu_x<?php echo $t08_beli_list->RowIndex ?>_VendorID"><?php echo (strval($t08_beli->VendorID->ViewValue) == "" ? $Language->Phrase("PleaseSelect") : $t08_beli->VendorID->ViewValue); ?></span>
</span>
