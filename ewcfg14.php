...
define("EW_PROJECT_ID", "{8746EF3F-81FE-4C1C-A7F8-AC191F8DDBB2}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'gwbydZok5038zzDe', TRUE); // Random key for encryption
...
define("EW_SENDER_EMAIL", "admin@selusin.net", TRUE); // Sender email address
