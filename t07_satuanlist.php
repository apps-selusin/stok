...
<?php if ($t07_satuan->Nama->Visible) { // Nama ?>
	...
	<?php } else { ?>
		<th data-name="Nama" class="<?php echo $t07_satuan->Nama->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t07_satuan->SortUrl($t07_satuan->Nama) ?>',2);"><div id="elh_t07_satuan_Nama" class="t07_satuan_Nama">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $t07_satuan->Nama->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($t07_satuan->Nama->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($t07_satuan->Nama->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
