...
$t92_log_add = NULL; // Initialize page object first

class ct92_log_add extends ct92_log {
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->Page_Terminate("t92_loglist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t92_logview.php")
...
// Create page object
if (!isset($t92_log_add)) $t92_log_add = new ct92_log_add();

// Page init
$t92_log_add->Page_Init();

// Page main
$t92_log_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t92_log_add->Page_Render();
?>
...
var CurrentForm = ft92_logadd = new ew_Form("ft92_logadd", "add");

// Validate form
ft92_logadd.Validate = function() {
...
ft92_logadd.Form_CustomValidate = 
...
ft92_logadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ft92_logadd.Lists["x_Status"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Status","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t91_log_status"};
ft92_logadd.Lists["x_Status"].Data = "<?php echo $t92_log_add->Status->LookupFilterQuery(FALSE, "add") ?>";
...
<?php $t92_log_add->ShowPageHeader(); ?>
<?php
$t92_log_add->ShowMessage();
?>
<form name="ft92_logadd" id="ft92_logadd" class="<?php echo $t92_log_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t92_log_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t92_log_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t92_log">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($t92_log_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($t92_log->No->Visible) { // No ?>
	<div id="r_No" class="form-group">
		<label id="elh_t92_log_No" for="x_No" class="<?php echo $t92_log_add->LeftColumnClass ?>"><?php echo $t92_log->No->FldCaption() ?></label>
		<div class="<?php echo $t92_log_add->RightColumnClass ?>"><div<?php echo $t92_log->No->CellAttributes() ?>>
...
<?php if ($t92_log->Keterangan->Visible) { // Keterangan ?>
	<div id="r_Keterangan" class="form-group">
		<label id="elh_t92_log_Keterangan" for="x_Keterangan" class="<?php echo $t92_log_add->LeftColumnClass ?>"><?php echo $t92_log->Keterangan->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $t92_log_add->RightColumnClass ?>"><div<?php echo $t92_log->Keterangan->CellAttributes() ?>>
...
<?php if ($t92_log->Keterangan2->Visible) { // Keterangan2 ?>
	<div id="r_Keterangan2" class="form-group">
		<label id="elh_t92_log_Keterangan2" for="x_Keterangan2" class="<?php echo $t92_log_add->LeftColumnClass ?>"><?php echo $t92_log->Keterangan2->FldCaption() ?></label>
		<div class="<?php echo $t92_log_add->RightColumnClass ?>"><div<?php echo $t92_log->Keterangan2->CellAttributes() ?>>
...
<?php if ($t92_log->Status->Visible) { // Status ?>
	<div id="r_Status" class="form-group">
		<label id="elh_t92_log_Status" for="x_Status" class="<?php echo $t92_log_add->LeftColumnClass ?>"><?php echo $t92_log->Status->FldCaption() ?></label>
		<div class="<?php echo $t92_log_add->RightColumnClass ?>"><div<?php echo $t92_log->Status->CellAttributes() ?>>
...
<?php if ($t92_log->TanggalJam->Visible) { // TanggalJam ?>
	<div id="r_TanggalJam" class="form-group">
		<label id="elh_t92_log_TanggalJam" for="x_TanggalJam" class="<?php echo $t92_log_add->LeftColumnClass ?>"><?php echo $t92_log->TanggalJam->FldCaption() ?></label>
		<div class="<?php echo $t92_log_add->RightColumnClass ?>"><div<?php echo $t92_log->TanggalJam->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("ft92_logadd", "x_TanggalJam", {"ignoreReadonly":true,"useCurrent":false,"format":1});
</script>
<?php } ?>
</span>
...
<?php if (!$t92_log_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $t92_log_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t92_log_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
