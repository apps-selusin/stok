...
$t10_hutangdetail_delete = NULL; // Initialize page object first

class ct10_hutangdetail_delete extends ct10_hutangdetail {
	...
	// Page object name
	var $PageObjName = 't10_hutangdetail_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t10_hutangdetaillist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t10_hutangdetail class, t10_hutangdetailinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t10_hutangdetaillist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t10_hutangdetail_delete)) $t10_hutangdetail_delete = new ct10_hutangdetail_delete();

// Page init
$t10_hutangdetail_delete->Page_Init();

// Page main
$t10_hutangdetail_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t10_hutangdetail_delete->Page_Render();
?>
...
var CurrentForm = ft10_hutangdetaildelete = new ew_Form("ft10_hutangdetaildelete", "delete");

// Form_CustomValidate event
ft10_hutangdetaildelete.Form_CustomValidate = 
...
ft10_hutangdetaildelete.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $t10_hutangdetail_delete->ShowPageHeader(); ?>
<?php
$t10_hutangdetail_delete->ShowMessage();
?>
<form name="ft10_hutangdetaildelete" id="ft10_hutangdetaildelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t10_hutangdetail_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t10_hutangdetail_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t10_hutangdetail">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($t10_hutangdetail_delete->RecKeys as $key) { ?>
...
<?php if ($t10_hutangdetail->id->Visible) { // id ?>
		<th class="<?php echo $t10_hutangdetail->id->HeaderCellClass() ?>"><span id="elh_t10_hutangdetail_id" class="t10_hutangdetail_id"><?php echo $t10_hutangdetail->id->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($t10_hutangdetail->Tgl->Visible) { // Tgl ?>
		<th class="<?php echo $t10_hutangdetail->Tgl->HeaderCellClass() ?>"><span id="elh_t10_hutangdetail_Tgl" class="t10_hutangdetail_Tgl"><?php echo $t10_hutangdetail->Tgl->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t10_hutangdetail->JumlahBayar->Visible) { // JumlahBayar ?>
		<th class="<?php echo $t10_hutangdetail->JumlahBayar->HeaderCellClass() ?>"><span id="elh_t10_hutangdetail_JumlahBayar" class="t10_hutangdetail_JumlahBayar"><?php echo $t10_hutangdetail->JumlahBayar->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$t10_hutangdetail_delete->RecCnt = 0;
$i = 0;
while (!$t10_hutangdetail_delete->Recordset->EOF) {
	$t10_hutangdetail_delete->RecCnt++;
	$t10_hutangdetail_delete->RowCnt++;

	// Set row properties
	$t10_hutangdetail->ResetAttrs();
	$t10_hutangdetail->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$t10_hutangdetail_delete->LoadRowValues($t10_hutangdetail_delete->Recordset);
...
<?php if ($t10_hutangdetail->id->Visible) { // id ?>
		<td<?php echo $t10_hutangdetail->id->CellAttributes() ?>>
<span id="el<?php echo $t10_hutangdetail_delete->RowCnt ?>_t10_hutangdetail_id" class="t10_hutangdetail_id">
...
<?php } ?>
<?php if ($t10_hutangdetail->Tgl->Visible) { // Tgl ?>
		<td<?php echo $t10_hutangdetail->Tgl->CellAttributes() ?>>
<span id="el<?php echo $t10_hutangdetail_delete->RowCnt ?>_t10_hutangdetail_Tgl" class="t10_hutangdetail_Tgl">
...
<?php } ?>
<?php if ($t10_hutangdetail->JumlahBayar->Visible) { // JumlahBayar ?>
		<td<?php echo $t10_hutangdetail->JumlahBayar->CellAttributes() ?>>
<span id="el<?php echo $t10_hutangdetail_delete->RowCnt ?>_t10_hutangdetail_JumlahBayar" class="t10_hutangdetail_JumlahBayar">
...
<?php
	$t10_hutangdetail_delete->Recordset->MoveNext();
}
$t10_hutangdetail_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t10_hutangdetail_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft10_hutangdetaildelete.Init();
</script>
<?php
$t10_hutangdetail_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t10_hutangdetail_delete->Page_Terminate();
?>
