...
class cforgotpwd extends ct96_employees {
...
<p class="login-box-msg"><?php echo $Language->Phrase("RequestPwd") ?></p>
	<div class="form-group">
		<div><input type="text" name="email" id="email" class="form-control ewControl" value="<?php echo ew_HtmlEncode($forgotpwd->Email) ?>" size="30" maxlength="30" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("UserEmail")) ?>"></div>
	</div>
