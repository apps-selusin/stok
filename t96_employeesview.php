...
<div class="nav-tabs-custom" id="t96_employees_view">
	<ul class="nav<?php echo $t96_employees_view->MultiPages->NavStyle() ?>">
		<li<?php echo $t96_employees_view->MultiPages->TabStyle("1") ?>><a href="#tab_t96_employees1" data-toggle="tab"><?php echo $t96_employees->PageCaption(1) ?></a></li>
		<li<?php echo $t96_employees_view->MultiPages->TabStyle("2") ?>><a href="#tab_t96_employees2" data-toggle="tab"><?php echo $t96_employees->PageCaption(2) ?></a></li>
		<li<?php echo $t96_employees_view->MultiPages->TabStyle("3") ?>><a href="#tab_t96_employees3" data-toggle="tab"><?php echo $t96_employees->PageCaption(3) ?></a></li>
		<li<?php echo $t96_employees_view->MultiPages->TabStyle("4") ?>><a href="#tab_t96_employees4" data-toggle="tab"><?php echo $t96_employees->PageCaption(4) ?></a></li>
	</ul>
	<div class="tab-content">
<?php } ?>
<?php if ($t96_employees->Export == "") { ?>
		<div class="tab-pane<?php echo $t96_employees_view->MultiPages->PageStyle("1") ?>" id="tab_t96_employees1">
<?php } ?>
...
<span id="el_t96_employees_LastName" data-page="1">
...
<span id="el_t96_employees_FirstName" data-page="1">
...
<span id="el_t96_employees_Title" data-page="1">
...
<span id="el_t96_employees_TitleOfCourtesy" data-page="1">
...
<span id="el_t96_employees_BirthDate" data-page="1">
...
<span id="el_t96_employees_HireDate" data-page="1">
...
<?php } ?>
<?php if ($t96_employees->Export == "") { ?>
		<div class="tab-pane<?php echo $t96_employees_view->MultiPages->PageStyle("2") ?>" id="tab_t96_employees2">
<?php } ?>
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
...
<?php } ?>
<?php if ($t96_employees->Export == "") { ?>
		<div class="tab-pane<?php echo $t96_employees_view->MultiPages->PageStyle("3") ?>" id="tab_t96_employees3">
<?php } ?>
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
...
<span id="el_t96_employees_HomePhone" data-page="3">
...
<span id="el_t96_employees__Email" data-page="3">
...
<span id="el_t96_employees_Photo" data-page="3">
...
<?php } ?>
<?php if ($t96_employees->Export == "") { ?>
		<div class="tab-pane<?php echo $t96_employees_view->MultiPages->PageStyle("4") ?>" id="tab_t96_employees4">
<?php } ?>
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
...
<span id="el_t96_employees_Notes" data-page="4">
...
<span id="el_t96_employees_ReportsTo" data-page="4">
...
<span id="el_t96_employees_Password" data-page="4">
...
<span id="el_t96_employees_UserLevel" data-page="4">
...
<span id="el_t96_employees_Username" data-page="4">
...
<span id="el_t96_employees_Activated" data-page="4">
...
<span id="el_t96_employees_Profile" data-page="4">
